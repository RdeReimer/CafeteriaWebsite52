...
def sucursales(request):
    ...
    return render(request, 'contactos.html', {'sucursales': sucursales})
...
def gracias(request):
    persona = request.GET.get("persona", "Repartidor")
    vehiculo = request.GET.get("vehiculo", "Vehículo")
